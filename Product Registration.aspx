<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Product Registration.aspx.cs" Inherits="Assignment_10.Product_Registration" %>
            ...
            <table class="w-100">
                ...
                <tr>
                    ...
                    <td class="auto-style11">
                        <asp:DropDownList ID="DropCat" runat="server" Height="45px" Width="125px">
                            <asp:ListItem></asp:ListItem>
                            <asp:ListItem>HeadPhone</asp:ListItem>
                            <asp:ListItem>Laptop</asp:ListItem>
                        </asp:DropDownList>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="DropCat" ErrorMessage="Enter Category First" ForeColor="#FF3300"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:Calendar ID="TxtCad" runat="server"></asp:Calendar>
                    </td>
                </tr>
                <tr>
